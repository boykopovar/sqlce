...
def _build_and_check(sdf_connection: RemoteConnection, sdf_scenario: SdfScenario, spec) -> None:
...
def test_sdf_edge_case_integer_extremes_full_structure_matches_source(
    ...
    _build_and_check(sdf_connection, sdf_scenario, INTEGER_EXTREMES_TABLE_SPEC)


def test_sdf_edge_case_numeric_extremes_full_structure_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, NUMERIC_EXTREMES_TABLE_SPEC)


def test_sdf_edge_case_float_extremes_full_structure_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, FLOAT_EXTREMES_TABLE_SPEC)


def test_sdf_edge_case_datetime_extremes_full_structure_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, DATETIME_EXTREMES_TABLE_SPEC)


def test_sdf_edge_case_guid_extremes_full_structure_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, GUID_EXTREMES_TABLE_SPEC)


def test_sdf_edge_case_huge_text_beyond_single_page_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, HUGE_TEXT_TABLE_SPEC)


def test_sdf_edge_case_huge_binary_beyond_single_page_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, HUGE_BINARY_TABLE_SPEC)


def test_sdf_edge_case_many_rows_full_structure_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, MANY_ROWS_TABLE_SPEC)


def test_sdf_edge_case_nullable_extremes_full_structure_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, NULLABLE_EXTREMES_TABLE_SPEC)


def test_sdf_edge_case_wide_mixed_types_full_structure_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, WIDE_MIXED_TYPES_TABLE_SPEC)


def test_sdf_edge_case_wide_row_page_split_full_structure_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, WIDE_ROW_PAGE_SPLIT_TABLE_SPEC)


def test_sdf_edge_case_many_bit_columns_full_structure_matches_source(
        sdf_scenario: SdfScenario, sdf_connection: RemoteConnection,
) -> None:
    _build_and_check(sdf_connection, sdf_scenario, MANY_BIT_COLUMNS_TABLE_SPEC)
