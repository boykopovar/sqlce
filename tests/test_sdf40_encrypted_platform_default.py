...
def test_sdf40_encrypted_platform_default_database_reads_table_rows(sdf_dir: Path) -> None:
    path = create_platform_default_encrypted_database(sdf_dir, PASSWORD)
...
def test_sdf40_encrypted_platform_default_database_table_schema(sdf_dir: Path) -> None:
    path = create_platform_default_encrypted_database(sdf_dir, PASSWORD)
